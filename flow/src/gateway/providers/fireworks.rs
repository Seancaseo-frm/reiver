...
//!
//! Fireworks AI hosts open-source models with fast inference behind an
...
//! | Env var | Description |
//! |---|---|
//! | `GATEWAY_FIREWORKS_BASE_URL` | API endpoint (default: `https://api.fireworks.ai/inference/v1`) |
//! | `GATEWAY_TIMEOUT_FIREWORKS_SECONDS` | HTTP timeout (default: 120) |
...
impl LlmProvider for FireworksProvider {
    ...
    fn supports_model(&self, model: &str) -> bool {
        model.starts_with("fireworks/")
    }

    #[tracing::instrument(
        name = "provider.fireworks.chat_completion",
    ...
    #[tracing::instrument(
        name = "provider.fireworks.stream_chat_completion",
        skip(self, request, api_key),
        fields(
            model = %request.model,
            gen_ai.provider.name = "fireworks",
