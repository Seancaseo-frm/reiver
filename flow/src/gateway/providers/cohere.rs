...
//!
//! Cohere provides Command R+ and other models behind an OpenAI-compatible
//! `/chat/completions` endpoint at their compatibility path.
//!
//! ## Configuration
//!
//! | Env var | Description |
//! |---|---|
//! | `GATEWAY_COHERE_BASE_URL` | API endpoint (default: `https://api.cohere.com/compatibility/v1`) |
//! | `GATEWAY_TIMEOUT_COHERE_SECONDS` | HTTP timeout (default: 120) |
...
impl LlmProvider for CohereProvider {
    ...
    #[tracing::instrument(
        name = "provider.cohere.chat_completion",
    ...
    #[tracing::instrument(
        name = "provider.cohere.stream_chat_completion",
        skip(self, request, api_key),
        fields(
            model = %request.model,
            gen_ai.provider.name = "cohere",
