...
//! | Env var | Description |
//! |---|---|
//! | `GATEWAY_GROQ_BASE_URL` | API endpoint (default: `https://api.groq.com/openai/v1`) |
//! | `GATEWAY_TIMEOUT_GROQ_SECONDS` | HTTP timeout (default: 120) |
...
impl LlmProvider for GroqProvider {
    ...
    #[tracing::instrument(
        name = "provider.groq.chat_completion",
    ...
    #[tracing::instrument(
        name = "provider.groq.stream_chat_completion",
        skip(self, request, api_key),
        fields(
            model = %request.model,
            gen_ai.provider.name = "groq",
