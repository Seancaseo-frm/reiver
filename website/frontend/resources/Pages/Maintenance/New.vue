    ...
    <div class="max-w-3xl mx-auto px-8 py-6">
      ...
      <div class="mb-6">
        <div>
          ...
          <h1 class="text-2xl font-semibold text-gray-900">Create Maintenance Window</h1>
          <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Schedule a maintenance period to silence alerts and pause health checks
          </p>
        </div>
      </div>
        ...
        <form @submit.prevent="handleSubmit" novalidate>
          ...
          <div class="flex justify-end items-center gap-3 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            >
              ...
              <span v-else>Create Maintenance Window</span>
            </button>
          </div>
        </form>
      </BaseCard>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const message = error.response?.data?.error || 'Failed to create maintenance window. Please try again.';
    alert(message);
  } finally {
    saving.value = false;
  }
